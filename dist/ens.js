...
async function getReverseRegistrarContract() {
  ...
  const reverseRegistrar = new Contract(reverseRegistrarAddr, reverseRegistrarContract, provider);
  return {
    reverseRegistrar
  };
}
...
async function getTestRegistrarContract() {
  ...
  const registrar = new Contract(testRegistrarAddr, testRegistrarContract, provider);
  return {
    registrar
  };
}
...
async function getENSEvent(event, {
  topics,
  fromBlock
}) {
...
export { getENS, getTestRegistrarContract, getReverseRegistrarContract, getENSContract, getENSEvent, getLabelhash, getNamehash, getNamehashWithLabelHash, getResolverContract, getOldResolverContract, getDnsRegistrarContract, getFifsRegistrarContract, normalize };