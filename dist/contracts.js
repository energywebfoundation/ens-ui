...
function getOldResolverContract({
  address,
  provider
}) {
...
function getTestRegistrarContract({
  address,
  provider
}) {
...
function getOldDnsRegistrarContract({
  parentOwner,
  provider
}) {
...
function getDnsRegistrarContract({
  parentOwner,
  provider
}) {
...
function getLegacyAuctionContract({
  address,
  provider
}) {
...
export { getTestRegistrarContract, getReverseRegistrarContract, getENSContract, getResolverContract, getOldResolverContract, getDnsRegistrarContract, getOldDnsRegistrarContract, getPermanentRegistrarContract, getPermanentRegistrarControllerContract, getLegacyAuctionContract, getDeedContract, getBulkRenewalContract, getOracleContract };